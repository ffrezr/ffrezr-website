---
slug: claude-managed-agents-guide
title: "Claude Managed Agents: Python Implementation Guide (2026)"
excerpt: >
  Claude Managed Agents launched April 8, 2026 at $0.08/session-hour. Build hosted agents with Python — includes a full dbt pipeline monitoring example.
...
For data engineering-specific workflows and CLAUDE.md setup, see the [Claude Code for Data Engineers guide](/blog/claude-code-for-data-engineers).
...
For SDK setup and CLAUDE.md configuration tips specific to data engineering, see [Claude Code for Data Engineers](/blog/claude-code-for-data-engineers). To explore all posts on this blog, visit the [home page](/).
...
For desktop automation and multi-app workflows without writing code, see [How to Use Claude Cowork](/blog/how-to-use-claude-cowork).
...
For dbt Cloud API integration patterns and BigQuery tool setup, see [Claude Code for Data Engineers](/blog/claude-code-for-data-engineers).
...
For Claude as a desktop automation agent rather than a coding tool, see [How to Use Claude Cowork](/blog/how-to-use-claude-cowork).
