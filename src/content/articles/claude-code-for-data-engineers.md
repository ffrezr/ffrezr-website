---
slug: claude-code-for-data-engineers
title: "Claude Code for Data Engineers: The Complete 2026 Guide"
excerpt: >
  72% of analytics engineers now prioritize AI coding. How to set up Claude Code with dbt, BigQuery, Airflow — CLAUDE.md templates, hooks, and BigQuery MCP server.
category: AI Tools
date: Apr 15, 2026
...
For knowledge workers who want Anthropic's desktop automation agent instead of a CLI tool, see [How to Use Claude Cowork: The Complete Guide](/blog/how-to-use-claude-cowork).
...
- Use `{{ dbt_utils.generate_surrogate_key([...]) }}` for surrogate keys — never `GENERATE_UUID()`
...
- No hardcoded project IDs or dataset names (use `{{ env_var('DBT_TARGET_PROJECT') }}`)
...
Browse the [Data Engineering](/blog) category for related pipeline and tooling posts.
...
A dedicated Claude Code vs Cursor deep-dive for data engineering teams is coming; check the [Data Engineering](/blog) category for updates.
...
Browse all posts in the [AI Tools](/blog) and [Data Engineering](/blog) categories for related deep-dives as they publish. For the full picture of Anthropic's desktop agent for non-code workflows, see the [How to Use Claude Cowork](/blog/how-to-use-claude-cowork) guide.
