...
slug: omniduc
title: Omniduc
seoTitle: "Omniduc: B2B EdTech in Chile"
role: Founder & CEO
period: Sep 2021 — Sep 2022
location: Valparaíso, Chile
description: "How I built Omniduc from scratch: a Chilean B2B EdTech startup that combined an adaptive video game with real-time learning analytics for math teachers. Architecture, validation, retrospective, and lessons after one year of operation."
metaDescription: "Founder retrospective of Omniduc, a Chilean B2B EdTech startup (2021-2022). Architecture, $25,000M CLP TAM, and 5 root causes of failure."
...
Omniduc was an EdTech startup I founded in Valparaíso between 2021 and 2022 to tackle one of the most persistent problems in the Chilean education system: poor math performance in primary school. The proposition combined two pieces. First, a math video game that replaced written exams with adaptive gameplay sessions. Second, a web portal where teachers could see, student by student and question by question, exactly where each student was struggling in real time.
...
- On state investment efficiency, Chile invests roughly $2,000,000 CLP per student per year in primary education ([Libertad y Desarrollo, 2020](https://lyd.org/wp-content/uploads/2020/10/partida-09_lp2021_mineduc.pdf)). With 2 million students enrolled and 50% missing minimum math competencies, the implied loss is ~$2 trillion CLP per year in investment that does not translate into the targeted learning outcomes.
...
<text x="360" y="28" font-size="16" font-weight="700" text-anchor="middle" fill="#222">Students with poor math performance</text>
<text x="360" y="46" font-size="12" text-anchor="middle" fill="#222" opacity="0.6">Primary education · Chile and Latin America</text>
<text x="20" y="100" font-size="14" fill="#222">Chile (PISA 2018)</text>
<text x="20" y="116" font-size="11" fill="#222" opacity="0.6">15-year-olds · below minimum competencies</text>
<rect x="240" y="86" width="189" height="38" fill="#222" opacity="0.85"></rect>
<text x="437" y="110" font-size="16" font-weight="700" fill="#222">52%</text>
<text x="20" y="184" font-size="14" fill="#222">6th grade LATAM (ERCE 2019)</text>
<text x="20" y="200" font-size="11" fill="#222" opacity="0.6">poor performance</text>
<rect x="240" y="170" width="178" height="38" fill="#222" opacity="0.65"></rect>
<text x="426" y="194" font-size="16" font-weight="700" fill="#222">49%</text>
<text x="20" y="268" font-size="14" fill="#222">3rd grade LATAM (ERCE 2019)</text>
<text x="20" y="284" font-size="11" fill="#222" opacity="0.6">lowest performance level</text>
<rect x="240" y="254" width="175" height="38" fill="#222" opacity="0.5"></rect>
<text x="423" y="278" font-size="16" font-weight="700" fill="#222">48%</text>
...
<text x="240" y="338" font-size="11" text-anchor="middle" fill="#222" opacity="0.6">0%</text>
<text x="422" y="338" font-size="11" text-anchor="middle" fill="#222" opacity="0.5">50%</text>
<text x="604" y="338" font-size="11" text-anchor="middle" fill="#222" opacity="0.6">100%</text>
</svg>
...
## Who Was Affected: The Five Stakeholder Groups

The Crea y Valida grant proposal forced us to quantify who exactly was affected by the math learning crisis, and at what scale. That stakeholder analysis ended up shaping how the product surfaced different views for different roles. Each group had different incentives, different decision power, and a different relationship with the learning data Omniduc produced.

<figure style="margin: 2.5rem 0;">
<svg viewBox="0 0 720 360" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Five stakeholder groups in Chilean primary education: 2,000,000 students, 112,000 teachers, 20,000 directors, parents, and the MINEDUC regulator." style="width:100%;height:auto;font-family:inherit;display:block">
<text x="360" y="28" font-size="16" font-weight="700" text-anchor="middle" fill="#222">Stakeholders · Chilean primary education</text>
<text x="360" y="46" font-size="12" text-anchor="middle" fill="#222" opacity="0.6">Five groups, four roles in the product, one regulator</text>
<rect x="40" y="90" width="120" height="80" rx="2" fill="#222" opacity="0.85"></rect>
<text x="100" y="120" font-size="12" font-weight="700" text-anchor="middle" fill="#fff">Students</text>
<text x="100" y="140" font-size="15" font-weight="700" text-anchor="middle" fill="#fff">2.0M</text>
<text x="100" y="158" font-size="11" text-anchor="middle" fill="#fff" opacity="0.8">User</text>
<rect x="180" y="100" width="120" height="70" rx="2" fill="#222" opacity="0.7"></rect>
<text x="240" y="128" font-size="12" font-weight="700" text-anchor="middle" fill="#fff">Teachers</text>
<text x="240" y="148" font-size="15" font-weight="700" text-anchor="middle" fill="#fff">112K</text>
<text x="240" y="164" font-size="11" text-anchor="middle" fill="#fff" opacity="0.8">User</text>
<rect x="320" y="110" width="120" height="60" rx="2" fill="#222" opacity="0.55"></rect>
<text x="380" y="135" font-size="12" font-weight="700" text-anchor="middle" fill="#fff">Directors / UTP</text>
<text x="380" y="153" font-size="15" font-weight="700" text-anchor="middle" fill="#fff">20K</text>
<text x="380" y="167" font-size="11" text-anchor="middle" fill="#fff" opacity="0.8">Client</text>
<rect x="460" y="120" width="120" height="50" rx="2" fill="#222" opacity="0.4"></rect>
<text x="520" y="142" font-size="12" font-weight="700" text-anchor="middle" fill="#222">Parents</text>
<text x="520" y="160" font-size="11" text-anchor="middle" fill="#222" opacity="0.7">Interested</text>
<rect x="600" y="130" width="80" height="40" rx="2" fill="#222" opacity="0.25"></rect>
<text x="640" y="148" font-size="11" font-weight="700" text-anchor="middle" fill="#222">MINEDUC</text>
<text x="640" y="162" font-size="11" text-anchor="middle" fill="#222" opacity="0.7">Regulator</text>
<text x="360" y="220" font-size="14" font-weight="700" text-anchor="middle" fill="#222">8,200 schools nationwide</text>
<text x="360" y="240" font-size="12" text-anchor="middle" fill="#222" opacity="0.65">Municipal · Subsidized-private · Private</text>
<text x="360" y="270" font-size="11" text-anchor="middle" fill="#222" opacity="0.55">State investment: ~$2,000,000 CLP per student / year</text>
<text x="360" y="285" font-size="11" text-anchor="middle" fill="#222" opacity="0.55">~$4 trillion CLP total · ~$2 trillion CLP lost to failed math outcomes</text>
<text x="360" y="320" font-size="11" text-anchor="middle" fill="#222" opacity="0.5">Sources: CEM MINEDUC 2018 · Libertad y Desarrollo 2020 · UNESCO UIS</text>
</svg>
<figcaption style="margin-top:0.75rem;text-align:center;font-size:0.875rem;color:#666;font-style:italic;">The five stakeholder groups in Chilean primary education, with Omniduc's product role for each: students and teachers as users, principals and UTP heads as clients, parents as interested parties, and MINEDUC as the regulator.</figcaption>
</figure>

- Students (user · 2 million in Chile) are the direct recipients of the educational service. They need significant teacher support, learn better through game-based formats, and can experience high anxiety in traditional assessment loops. Their Omniduc view is the game itself, the in-game economy, the rewards system, and the wizard mascot — the student doesn't see dashboards, they see an adventure.
- Teachers (user · 112,000 in Chile) have a primary objective: that their students learn. They face long working hours, anxiety, unmotivated or struggling students, and a chronic time deficit. Their Omniduc view is the live class dashboard, the per-objective drilldown, the per-question breakdown, and the question-bank editor. This is the single most important view in the product.
- Directors and UTP heads (client · 20,000 in Chile) — principals and Academic Affairs heads. Their function is to manage the school and achieve the best educational performance, which is why they care about both student learning and teacher performance. Their Omniduc view is the aggregate curriculum-coverage report, the school-wide performance trends, and the teacher activity summary. In the Premium plan, this is a separate view from the teacher dashboard.
- Parents (interested party) pay for the educational service but don't receive it directly. They want their investment to be effective and frequently lack visibility into their child's actual progress. Their Omniduc view is a simplified per-student progress report, available in the Premium plan, showing what topics the child has mastered and where they need reinforcement.
- MINEDUC (regulator) sets the National Curriculum, defines Priority Learning Objectives, runs SIMCE, and invests through the SEP (Preferential Educational Subsidy) program. It has explicit interest in improving learning levels through reorienting the PEI (Educational Project) and PME (Improvement Plan) instruments. Omniduc's role is alignment with MINEDUC priority objectives, designed to fit within SEP-fundable categories.

The four-role product (student, teacher, principal, parent) was one of the most explicit differentiators against competitors. Umáximo, Matific, and Eduten all surfaced strong student and teacher experiences but did not consistently expose dedicated views for principals and parents. Omniduc's Premium plan made that multi-stakeholder coverage the explicit upsell.
...
The video game was called Ascendia: Magic Lands. We designed it for touch devices and computers, in an adventure format with worlds divided into islands and each island with several towers to climb. The pedagogical metaphor was direct:
...
<text x="360" y="28" font-size="16" font-weight="700" text-anchor="middle" fill="#222">Business model · B2B Service</text>
<text x="360" y="46" font-size="12" text-anchor="middle" fill="#222" opacity="0.6">Annual subscription paid by the school</text>
<rect x="60" y="100" width="220" height="100" rx="2" fill="none" stroke="#222" stroke-width="2"></rect>
<text x="170" y="138" font-size="18" font-weight="700" text-anchor="middle" fill="#222">Omniduc</text>
<text x="170" y="158" font-size="12" text-anchor="middle" fill="#222" opacity="0.6">Video game + Teacher Portal</text>
<text x="170" y="174" font-size="12" text-anchor="middle" fill="#222" opacity="0.6">Learning data</text>
<line x1="280" y1="130" x2="440" y2="130" stroke="#222" stroke-width="1.5" marker-end="url(#omni-arrow)"></line>
<text x="360" y="120" font-size="12" font-weight="700" text-anchor="middle" fill="#222">Service subscription</text>
<line x1="440" y1="170" x2="280" y2="170" stroke="#222" stroke-width="1.5" marker-end="url(#omni-arrow)"></line>
<text x="360" y="194" font-size="12" font-weight="700" text-anchor="middle" fill="#222">$20,000 CLP annual / student</text>
<rect x="440" y="100" width="220" height="100" rx="2" fill="none" stroke="#222" stroke-width="2"></rect>
<text x="550" y="138" font-size="18" font-weight="700" text-anchor="middle" fill="#222">Schools</text>
<text x="550" y="158" font-size="12" text-anchor="middle" fill="#222" opacity="0.6">Primary education</text>
<text x="550" y="174" font-size="12" text-anchor="middle" fill="#222" opacity="0.6">2nd to 6th grade</text>
<text x="360" y="248" font-size="12" text-anchor="middle" fill="#222" opacity="0.65">TAM Chile: $25,000M CLP · 8,200 schools · 1.25M students</text>
<text x="360" y="264" font-size="11" text-anchor="middle" fill="#222" opacity="0.5">Source: CEM Chile, 2018</text>
</svg>
...
<text x="360" y="28" font-size="16" font-weight="700" text-anchor="middle" fill="#222">EdTech Market in Latin America</text>
<text x="360" y="46" font-size="12" text-anchor="middle" fill="#222" opacity="0.6">Projected size · USD billions · CAGR 14.5%</text>
...
<text x="50" y="304" font-size="11" text-anchor="end" fill="#222" opacity="0.6">0</text>
<text x="50" y="240" font-size="11" text-anchor="end" fill="#222" opacity="0.6">10</text>
<text x="50" y="176" font-size="11" text-anchor="end" fill="#222" opacity="0.6">20</text>
<text x="50" y="112" font-size="11" text-anchor="end" fill="#222" opacity="0.6">30</text>
...
<text x="90" y="276" font-size="11" text-anchor="middle" fill="#222" opacity="0.7">2025</text>
<text x="90" y="240" font-size="12" font-weight="700" text-anchor="middle" fill="#222">$7.5B</text>
<text x="670" y="104" font-size="12" font-weight="700" text-anchor="middle" fill="#222">$28.9B</text>
<text x="670" y="318" font-size="11" text-anchor="middle" fill="#222" opacity="0.7">2035</text>
<text x="380" y="170" font-size="12" font-weight="700" text-anchor="middle" fill="#222" opacity="0.85">K-12 = 42% of the market</text>
</svg>
...
<text x="360" y="28" font-size="16" font-weight="700" text-anchor="middle" fill="#222">Timeline · Sep 2021 to Sep 2022</text>
<line x1="60" y1="150" x2="680" y2="150" stroke="#222" stroke-width="1.5"></line>
<circle cx="100" cy="150" r="7" fill="#222"></circle>
<text x="100" y="95" font-size="12" font-weight="700" text-anchor="middle" fill="#222">Sep 2021</text>
<text x="100" y="115" font-size="11" text-anchor="middle" fill="#222" opacity="0.7">Prototype</text>
<text x="100" y="129" font-size="11" text-anchor="middle" fill="#222" opacity="0.7">agreement</text>
<circle cx="245" cy="150" r="7" fill="#222"></circle>
<text x="245" y="175" font-size="12" font-weight="700" text-anchor="middle" fill="#222">Dec 2021</text>
<text x="245" y="195" font-size="11" text-anchor="middle" fill="#222" opacity="0.7">Semilla Expande</text>
<text x="245" y="209" font-size="11" text-anchor="middle" fill="#222" opacity="0.7">Fund awarded</text>
<circle cx="390" cy="150" r="7" fill="#222"></circle>
<text x="390" y="95" font-size="12" font-weight="700" text-anchor="middle" fill="#222">May 2022</text>
<text x="390" y="115" font-size="11" text-anchor="middle" fill="#222" opacity="0.7">First functional</text>
<text x="390" y="129" font-size="11" text-anchor="middle" fill="#222" opacity="0.7">MVP version</text>
<circle cx="535" cy="150" r="7" fill="#222"></circle>
<text x="535" y="175" font-size="12" font-weight="700" text-anchor="middle" fill="#222">Jul 2022</text>
<text x="535" y="195" font-size="11" text-anchor="middle" fill="#222" opacity="0.7">Agreements with</text>
<text x="535" y="209" font-size="11" text-anchor="middle" fill="#222" opacity="0.7">3 pilot schools</text>
<circle cx="660" cy="150" r="9" fill="#222" stroke="#222" stroke-width="2"></circle>
<text x="660" y="95" font-size="12" font-weight="700" text-anchor="middle" fill="#222">Sep 2022</text>
<text x="660" y="115" font-size="11" text-anchor="middle" fill="#222" opacity="0.7">Company</text>
<text x="660" y="129" font-size="11" text-anchor="middle" fill="#222" opacity="0.7">closure</text>
<text x="360" y="255" font-size="12" text-anchor="middle" fill="#222" opacity="0.6">12 months · 5 people · 1 public fund · 1 institutional partnership · 3 pilots</text>
</svg>
...
- Semilla Expande Fund awarded (Corfo) — funded development of the first MVP version. Corfo Semilla Expande is a public accelerator fund for pre-revenue startups, historically one of the main early-stage financing vehicles in the Chilean startup ecosystem.

### 2022

- First functional MVP version — video game plus teacher portal with authentication, course management, and overall and individual performance dashboards.
